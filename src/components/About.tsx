    ...
    <section id="about" className="px-4 py-16 md:px-8 md:py-24">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mt-6 max-w-3xl space-y-4 text-neutral-300">
          <p>
            I'm studying .NET-development and has yet worked with C#, SQL,
            NoSQL, React, Typescript, HTML, CSS.
          </p>
          <p>
            Before i started studying i used to work as a CNC-Machinist /
            technician, i did everything between raw meterial to finished
          ...
          <p>
            ...
            Otherwise i'm exploring new services to self-host in my homelab,
            more homeautomations or new developer skills.
          </p>
        </div>
      </div>
    </section>
