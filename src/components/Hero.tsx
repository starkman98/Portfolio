...
const Hero = () => {
  return (
    <section className="py-16 flex flex-col items-center justify-center overflow-hidden">
      <div className="absolute inset-0 hero-glow pointer-events-none" />

      <div className="section-container relative z-10 py-12 w-full mx-auto max-w-5xl">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <div className="flex flex-wrap gap-4 justify-center lg:justify-start animate-fade-up-delay">
              <a
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-lg border border-neutral-700 bg-neutral-900/50 hover:border-primary hover:bg-primary/20 transition-all duration-300 text-sm font-medium"
              >
              ...
              <a
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-lg border border-neutral-700 bg-neutral-900/50 hover:border-primary hover:bg-primary/20 transition-all duration-300 text-sm font-medium"
              >
                <BsGithub className="w-4 h-4 text-primary" />
                <span>GitHub</span>
              </a>
              <a
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-lg border border-neutral-700 bg-neutral-900/50 hover:border-primary hover:bg-primary/20 transition-all duration-300 text-sm font-medium"
              >
                <BsLinkedin className="w-4 h-4 text-primary" />
                <span>LinkedIn</span>
              </a>
              <a
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-lg border border-neutral-700 bg-neutral-900/50 hover:border-primary hover:bg-primary/20 transition-all duration-300 text-sm font-medium"
              >
                <BsPhone className="w-4 h-4 text-primary" />
